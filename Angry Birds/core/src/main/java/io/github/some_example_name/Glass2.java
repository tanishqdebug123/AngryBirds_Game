...
public class Glass2 extends Actor{
    ...
    public Glass2(World world, float x, float y, float width, float height, float angle){
        this.world = world;
        this.width=width;
        this.height=height;
        this.initialAngle=angle;

        wb2_texture=new Texture("glass2.png");
        setWidth(width);
        setHeight(height);
        ...
        blockShape.setAsBox(width /2.4f / pixels, height / 2.1f / pixels);
