...
public class Woodenblock3 extends Actor{
    ...
    public Woodenblock3(World world, float x, float y, float width, float height){
        this.world = world;
        this.width=width;
        this.height=height;

        wb2_texture=new Texture("woodenblock3.png");
        setWidth(width);
        setHeight(height);
