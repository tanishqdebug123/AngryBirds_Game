...
public class YellowBird extends Actor {
    private Texture yellowbird_texture;
    Body body;
    private World world;
    ...
    public YellowBird(World world, float x, float y, float width, float height) {
        this.world = world;
        this.width = width;
        this.height = height;

        yellowbird_texture = new Texture("yellow.png");
    ...
    public void draw(Batch batch, float parentAlpha) {
        batch.draw(yellowbird_texture, getX(), getY(), width, height);
    }
