...
public class Glass1 extends Actor{
    ...
    public Glass1(World world, float x, float y, float width, float height, float angle){
        this.world = world;
        this.width=width;
        this.height=height;
        this.initialAngle=angle;

        wb2_texture=new Texture("horizontalglass.png");
        setWidth(width);
        setHeight(height);
        ...
        blockShape.setAsBox(width /2.1f / pixels, height / 2.1f / pixels);
