...
public class Woodenblock2 extends Actor{
    ...
    public Woodenblock2(World world, float x, float y, float width, float height){
        this.world = world;
        this.width=width;
        this.height=height;

        wb2_texture=new Texture("woodenblock2.png");
        setWidth(width);
        setHeight(height);
        ...
        blockShape.setAsBox(width / 1.8f / pixels, height / 4f / pixels);
